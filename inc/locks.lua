...
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- التقييد بالفديو بالتأكيد تم فتحه .\n⋆'
else 
redis:del(max..':tqeed_video:'..msg.chat_id_)
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم فتح التقييد بالفديـو .\n⋆'
end
end
...
if not msg.Director then return "-› هذا الامر يخص :\n-(المدير، المالك، المطور) فقط ." end
if redis:get(max..':tqeed_photo:'..msg.chat_id_) then
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- التقييد بالصور بالتأكيد تم قفلها .\n⋆'
else
redis:set(max..':tqeed_photo:'..msg.chat_id_,true)
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم قفل التقييد بالصور .\n⋆'
end
end
...
if not msg.Director then return "-› هذا الامر يخص :\n-(المدير، المالك، المطور) فقط ." end
if not redis:get(max..':tqeed_photo:'..msg.chat_id_) then
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- التقييد بالصور بالتأكيد تم فتحها .\n⋆'
else 
redis:del(max..':tqeed_photo:'..msg.chat_id_)
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم فتح التقييد بالصور .\n⋆'
end
end
---------------Lock twasel-------------------
...
if not msg.SudoBase then return "-› هذا الامر يخص المّـطور فقط !!!" end
if not redis:get(max..'lock_brod') then
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- اذاعة المطورين بالتأكيد تم تعطيلها .\n⋆'
else
redis:del(max..'lock_brod')
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم تعطيل اذاعة المّـطورين .\n⋆'
end
end
function unlock_brod(msg)
if not msg.SudoBase then return "-› هذا الامر يخص المّـطور فقط !!!" end
if redis:get(max..'lock_brod') then
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- اذاعة المطورين بالتأكيد تم تفعيلها .\n⋆'
else 
redis:set(max..'lock_brod',true)
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم تفعيل اذاعة المّـطورين .\n⋆'
end
end

---------------Lock replay-------------------
function lock_replay(msg)
if not msg.Admin then return "-› هذا الامر يخص الادمنيه وما فوق ." end
if not redis:get(max..'replay'..msg.chat_id_) then
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- الردود بالتأكيد تم تعطيلها .\n⋆'
else
...
return '-› أهلا عزيزي '..msg.TheRankCmd..'\n- نظام البوت الخدمي بالتأكيد تم تعطيله .\n⋆'
else
redis:del(max..'lock_service')
return '-› أهلا عزيزي '..msg.TheRankCmd..'\n- تم تعطيل نظام البوت الخدمي .\n⋆'
end
end
...
return '-› أهلا عزيزي '..msg.TheRankCmd..'\n- البوت الخدمي بالتأكيد تم تفعيله .\n⋆'
else 
redis:set(max..'lock_service',true)
return '-› أهلا عزيزي'..msg.TheRankCmd..'\n- تم تفعيل نظام البوت الخدمي .\n⋆\n- اصبح البوت الان بأمكان اي شخص\n- ان يستخدم البوت للتفعيل .'
end
end
...
return '-› أهلا عزيزي '..msg.TheRankCmd..'\n- البوتات بالطرد بالتأكيد تم قفله .\n⋆'
else
redis:set(max..'lock_bots'..msg.chat_id_,true)
...
return '-› أهلا عزيزي '..msg.TheRankCmd..'\n- البوتات بالطرد بالتأكيد تم فتحها .\n⋆'
else 
redis:del(max..'lock_bots_by_kick'..msg.chat_id_)
